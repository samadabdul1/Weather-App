      ...
      <ToggleMenu>
        {({on,toggle})=>(
          <ToggleFunction>
            ...
            <ToggleContainer>
              <LineOne>
                <WindSpeed><ToggleMenuIcon><img src={"https://cdn0.iconfinder.com/data/icons/speed-related-1/66/41-512.png"}/></ToggleMenuIcon> Wind speed<span>{windSpeed} km/h</span>
                  </WindSpeed>
                <Humidity><ToggleMenuIcon><img src={"https://cdn3.iconfinder.com/data/icons/smart-farm/48/Humidity-512.png"}/></ToggleMenuIcon>Humidity<span>{humidity}%</span></Humidity>
              </LineOne>
              <LineTwo>
                <Pressure><ToggleMenuIcon><img src={"https://cdn2.iconfinder.com/data/icons/miscellaneous-12/24/miscellaneous-25-512.png"}/></ToggleMenuIcon>Pressure<span>{pressure} hPa</span></Pressure>
                <SunRiseAndSunSet>
                  <Heading>Sun Rise and Sun Set Timings</Heading>
                  <Timing>
                    <SunRiseTime><ToggleMenuIcon><img src={"https://cdn0.iconfinder.com/data/icons/fitness-95/24/sunrise-512.png"}/></ToggleMenuIcon>Sun Rise<span>{timeConverter(sunRiseTime)}</span></SunRiseTime>
                    <SunSetTime><ToggleMenuIcon><img src={"https://cdn3.iconfinder.com/data/icons/farmer-garden-weather/128/_sunset_weather_sun-21-512.png"}/></ToggleMenuIcon>Sun Set<span>{timeConverter(sunSetTiming)}</span></SunSetTime>
                  </Timing>
                </SunRiseAndSunSet>
              </LineTwo>
            </ToggleContainer>
