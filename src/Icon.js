...
const Icon =props =>{
  ...
  switch (props.condition) {
    case "Clouds":
      icon = `https://cdn1.iconfinder.com/data/icons/weather-189/64/weather-icons-cloudy-3-128.png`;
      break;
    case "Clear":
      icon = `https://www.iconfinder.com/icons/2087721/sun_sunny_weather_icon`;
      break;
    case "Haze":
